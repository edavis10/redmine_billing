...
Redmine::Plugin.register :redmine_billing do
  ...
  permission(:use_accounts_payable, { :accounts_payables => [:index, :new, :create, :edit, :update, :destroy, :context_menu, :bulk_edit, :bulk_update, :auto_complete_for_vendor_invoice_number, :timesheet, :update_time_entries, :unbilled_po, :unspent_labor, :unbilled_labor] })
